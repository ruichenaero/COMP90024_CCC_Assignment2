...
import  region_sport_count from '../data/region_sport_count.json';
...
export default function Statistic2() {
  ...
  const data = {
    labels: region_sport_count.features.map(row => {
      return row.properties.region_name
      }),
    datasets: [
      {
        label: 'Region sport count',
        data: region_sport_count.features.map(row => {
          ...
          <Layout className="site-layout">
            ...
            <Content style={{ margin: '0 16px' }}>
              ...
              <div className="site-layout-background" style={{ padding: 24, minHeight: 360 }}>
                  ...
                  <Bar data={data} options={options} style={{ width: 850,height: 500, textAlign: 'center'}}/>
                  <div style={{ height: 100 }}></div>
                  <Pie data={data_pie} style={{ height: 800, width: 800 }}/>                
              </div>
            </Content>
